...
if ($_SERVER['REQUEST_METHOD'] === 'POST') 
{
    ...
    $ini->data['/Script/DeadMatter.DMGameSession']['admins'][] = $newsteamid;
    $ini->write();
    $test = array("[]=", "[] = ", " = ");
    ...
    file_put_contents($a, $c);
        ...
        $_SESSION['success'] = 'Player added to the ingame Admin List successfully!';
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Add a Admin on the server</h2>
        </div>
    </div>
    <!-- Flash messages -->
